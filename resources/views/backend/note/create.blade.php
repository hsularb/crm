                        ...
                        <form method="post" action="{{ route('note.store') }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea type="text" name="note" id="input-name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Note Description') }}" value="{{ old('name') }}" required autofocus></textarea>
